...
class NavigationMockActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(LinearLayout(this).apply {
            ...
            listOf(
                ...
                addView(Button(this@NavigationMockActivity).apply {
                    text = title
                    setOnClickListener {
                        MockMode.set(this@NavigationMockActivity, mode)
                        refresh()
                    }
