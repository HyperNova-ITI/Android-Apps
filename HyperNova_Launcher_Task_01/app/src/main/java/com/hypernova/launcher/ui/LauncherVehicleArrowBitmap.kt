...
/** HyperNova navigation arrow used only to render received positions. */
internal object LauncherVehicleArrowBitmap {
    fun create(context: Context): Bitmap {
        ...
        val outline = ContextCompat.getColor(context, R.color.hypernova_cyan_dark)
        ...
        canvas.drawCircle(center, center, size * 0.29f, paint)
    ...
    private const val MARKER_SIZE_DP = 46
