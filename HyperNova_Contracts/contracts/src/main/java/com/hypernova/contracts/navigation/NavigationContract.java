...
public final class NavigationContract {
    ...
    public static final String PLACE_CONTACT_SERVICE =
            "com.hypernova.navigation.service.NavigationPlaceContactService";
    public static final String BIND_PLACE_CONTACT_ACTION =
            "com.hypernova.navigation.action.BIND_PLACE_CONTACT";
    ...
    public static final String OP_GET_DESTINATION_CONTACT = "get_destination_contact";
    ...
    public static final long PLACE_CONTACT_TIMEOUT_MILLIS = 10 * 1000L;
    ...
    public static final String ERROR_NO_PHONE_NUMBER = "NO_PHONE_NUMBER";
